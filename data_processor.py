...
# Only these component names will be saved (Set = faster lookup)
ALLOWED_NAMES = {
...
def process_hardware_data():
    ...
    for category in os.listdir(INPUT_FOLDER):
        ...
        for filename in os.listdir(category_path):
            if filename.endswith(".json"):
                ...
                try:
                    ...
                    # Skip if name is missing or not in allowed list
                    if not filtered_item["name"] or filtered_item["name"] not in ALLOWED_NAMES:
                        continue
        ...
        if processed_items:
            ...
            print(f"No matching items found in category '{category}'.")
